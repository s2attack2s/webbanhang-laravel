...
@section('scripts')
<script src="/js/Home/Product.js" type="text/javascript"></script>
@stop
...
<section class="product-section">
    <div class="container product-container">
        <div class="link">
            @if($name)
            <h4>Kết quả tìm kiếm cho : {{$name}}</h4>
            @endif
        </div>
        @if($product)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="content-category">
                            <form class="form-fitter" action="/filter" role="search" method="get">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="filter-search">Áp dụng</button>
                    </div>
                </div>
            </div>
        </div>
