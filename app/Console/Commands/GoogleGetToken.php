...
class GoogleGetToken extends Command
{
    ...
    private function getClient()
    {
        ...
        $client->setApplicationName('Web_BanHang'); // đặt tên cho ứng dụng (không quan trọng lắm)
    ...
    if (!file_exists(dirname($credentialsPath))) {
        mkdir(dirname($credentialsPath), 777, true); //nhớ để quyền truy cập file là 777 nhé
    }
